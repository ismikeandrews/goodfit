        ...
        <div class="card-body">
          <form method="POST" action="candidato/cadastro">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="nascimento" type="text" class="form-control @error('nascimento') is-invalid @enderror" name="nascimento" value="{{ old('nascimento') }}" required autocomplete="nascimento" autofocus>
