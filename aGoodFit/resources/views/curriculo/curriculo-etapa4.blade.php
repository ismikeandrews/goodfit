<div class="curriculo-title">
  ...
  <div class="curriculo-etapa4">
    ...
    <div class="curriculo-content-item">
        <input value="{{$categoria->codCategoria}}" type="checkbox" id="objetivo-{{$categoria->nomeCategoria}}" class="curriculo-checkbox" name="categorias[]" @isset($curriculo) @if(in_array($categoria->codCategoria, $curriculo->categorias)) checked @endif @endisset/>
