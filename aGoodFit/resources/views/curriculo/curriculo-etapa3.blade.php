...
<div class="curriculo-etapa3">
    @foreach ($habilidades as $habilidade)
        <div class="curriculo-content-item">
          <input value="{{$habilidade->codAdicional}}" type="checkbox" id="habilidade-{{$habilidade->nomeAdicional}}" class="curriculo-checkbox" name="habilidades[]" @isset($curriculo) @if(in_array($habilidade->codAdicional, $curriculo->habilidades)) checked @endif @endisset/>
