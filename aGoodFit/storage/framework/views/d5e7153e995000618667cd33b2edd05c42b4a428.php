    ...
    <div class="curriculo-etapa1-submenu">
      <div class="curriculo-etapa1-submenu-item is-active">
        <img src="<?php echo e(asset('images/componentes/etapa1-video.svg')); ?>" alt="Currículo - Descrição sobre mim em forma de vídeo" class="curriculo-etapa1-submenu-item-icon">
      </div>

      <div class="curriculo-etapa1-submenu-item">
        <img src="<?php echo e(asset('images/componentes/etapa1-texto.svg')); ?>" alt="Currículo - Descrição sobre mim em forma de texto" class="curriculo-etapa1-submenu-item-icon">
      </div>
    </div>
    ...
    <div class="curriculo-etapa1-content is-active">
        <label for='arquivo-video'>
          <div class="curriculo-etapa1-content-video">
            <img src="<?php echo e(asset('images/icones/video.png')); ?>" alt="Currículo - Descrição sobre mim em forma de vídeo" class="curriculo-etapa1-content-video-icon">
...
<?php /**PATH /Applications/MAMP/htdocs/new-vision/aGoodFit/resources/views/curriculo/curriculo-etapa1.blade.php ENDPATH**/ ?>